 ...
 * 2017-09-14T17:30:23.191+08:00
 * Generated source version: 3.2.0
 *
 */
public final class VoucherServicesSoap_VoucherServicesSoap_Client {
    ...
    public static void main(String args[]) throws java.lang.Exception {

        {
            ...
            String faxiAfterMoney = "1000";
            String overdueAfterMoney = "1000";
            String afterMoney3 = "1000";
            String insuranceMoney = "1000";
            String investigationMoney = "1000";
            String departMentName2 = "邢郭";
            String kingdeeCode = "11";
            String kehuNumber = "1500027";
            ...
            entries0.setFAmount(Double.valueOf(incomeMoney)); //金额   永通需要传的字段信息 填写
            ...
            entries0.setFAccountNumber( "1001.02" ); //科目编码 填写 暂用这个到时改回1101
            ...
            detailEntriesaa.setFDetailNumber(kehuNumber);
            entriesa.setFAmount( Double.valueOf( afterMoney ) ); //金额   永通需要传的字段信息
            ...
            entries01.setFAmount(Double.valueOf(incomeMoney)); //金额   永通需要传的字段信息 填写
            ...
            entries01.setFAccountNumber( "1001.02" ); //科目编码 填写 暂用这个到时改回1101
            ...
            detailEntries11.setFDetailNumber(kehuNumber);
            ...
            java.lang.String _update_strPassword = "";
